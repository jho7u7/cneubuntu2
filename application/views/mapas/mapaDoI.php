<main>
	<h1 class="text-center">~ REPORTE GENERAL DE CANDIDATOS DERECHA E IZQUIERDA ~</h1>
	<div class="row">
    <div class="col-md-10">
    ...
    <div class="col-md-2">
			...
			<table class="table table-striped table-hover table-responsive" >
					<tr>
							...
							<td class="text-center">~ CANDIDATOS DE DERECHA ~</td>
					</tr>
					<tr>
							<th class="text-center"><img src="<?php echo base_url();?>/assets/images/iconRed.png"></th>
							<td class="text-center">~ CANDIDATOS A IZQUIERDA ~</td>
					</tr>
...
function initMap()
{
	...
	<?php if($lugaresDerecha && $lugaresIzquierda): ?>
		<?php foreach ($lugaresDerecha as $lugarTemporal): ?>
		...
		<?php foreach ($lugaresIzquierda as $lugarTemporal): ?>
		var coordenadaTemporal=new google.maps.LatLng(<?php echo $lugarTemporal->latitud_can;?>,<?php echo $lugarTemporal->longitud_can;?>);
		var marcador=new google.maps.Marker({
			position:coordenadaTemporal,
			title:"<?php echo $lugarTemporal->nombre_can; echo ' - ' ;echo $lugarTemporal->movimiento_can;?>",
